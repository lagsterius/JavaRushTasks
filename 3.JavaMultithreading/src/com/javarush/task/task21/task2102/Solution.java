...
public class Solution {
    ...
    public static boolean isAllModifiersContainSpecificModifier(int allModifiers, int specificModifier) {
        if ((Modifier.isPublic(allModifiers) && specificModifier == Modifier.PUBLIC) ||
                (Modifier.isStatic(allModifiers) && specificModifier == Modifier.STATIC) ||
                    (Modifier.isPrivate(allModifiers) && specificModifier == Modifier.PRIVATE) ||
                        (Modifier.isProtected(allModifiers) && specificModifier == Modifier.PROTECTED))
            return true;
