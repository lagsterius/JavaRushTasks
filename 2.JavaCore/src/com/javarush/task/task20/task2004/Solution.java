...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String res = String.valueOf(i) + " " + String.valueOf(j) + " " + staticString;
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            inputStream.close();
            String[] pr = new String(buffer).split(" ");
            i = Integer.valueOf(pr[0]);
            j = Integer.valueOf(pr[1]);
            staticString = "";
            for (int k = 2; k < pr.length; k++)
                staticString+= pr[k] + " ";
            staticString = staticString.substring(0, staticString.length() - 1);
            System.out.println();
        }
